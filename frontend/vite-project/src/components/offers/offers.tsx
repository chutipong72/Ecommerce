...
const offers = () => {
  return (
    <div className="w-[80%] h-[60%] flex m-auto py-0 px-[140px] mb-[150px] bg-gradient-to-b from-purple-200 to-green-50 bg-opacity-60 ">
      <div className="flex-1 flex flex-col justify-center sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/2">
        <p className="text-black text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-6xl font-semibold">
          Exclusive
        </p>
        <p className="text-black text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-6xl font-semibold">
          Offers For You
        </p>
        <p className="text-black text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-5xl font-semibold">
